...
function populateCommodities(commodity_id) {
    var commodity_select = document.getElementById(commodity_id);
    commodity_select.length = 0;
    commodity_select.options[0] = new Option('Select Commodity', '');
    commodity_select.selectedIndex = 0;
    for (var i = 0; i < uniqueCommodities.length; i++) {
        commodity_select.options[commodity_select.length] = new Option(uniqueCommodities[i], uniqueCommodities[i]);
    }
}
// Function to populate Market
function populateMarket(Market_id) {
    var Market_select = document.getElementById(Market_id);
    Market_select.length = 0;
    Market_select.options[0] = new Option('Select Market', '');
    Market_select.selectedIndex = 0;
    for (var i = 0; i < uniqueMarket.length; i++) {
        Market_select.options[Market_select.length] = new Option(uniqueMarket[i], uniqueMarket[i]);
    }
}
